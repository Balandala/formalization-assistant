...
- Проверяет .docx документы без внесения изменений.
- Показывает diff между исходной и обработанной версией документа.
- По чекбоксу генерирует содержание по найденным заголовкам и вставляет его выбранной страницей.
...
## 🔌 Доступ идет по адресу localhost:8000
